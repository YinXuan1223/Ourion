...
ann_file_train=info_root + f"/b2d_infos_train_with_style.pkl"  # [StyleDrive]
...
find_unused_parameters=False  # original; style_proj is always used so no unused params
...
checkpoint_config = dict(interval=15000, max_keep_ckpts=2,
...
load_from='ckpts/Orion.pth'
# [StyleDrive] resume from last GOOD checkpoint (iter_15000 was truncated by the
# HDD5 full-disk crash; iter_10000 is the last complete one). Restores iter/optimizer/lr.
resume_from='adzoo/orion/work_dirs/orion_stage2_diff_style_train/iter_10000.pth'